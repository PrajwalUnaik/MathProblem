...
struct DivisionView: View {
    ...
    var body: some View {
        ZStack {
            ...
            LinearGradient(gradient: Gradient(stops: [Gradient.Stop(color: Color.white, location: 0), Gradient.Stop(color: Color.brown, location: 1)]), startPoint: .topLeading, endPoint: .bottomTrailing)
                .ignoresSafeArea(.all)
    ...
    func generateAnswer() {
        ...
        for _ in 0...2 {
            answerList.append(Int.random(in: 0...(difficulty/2)))
        }
