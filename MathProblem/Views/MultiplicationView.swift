...
struct MultiplicationView: View {
    ...
    var body: some View {
        ZStack {
            ...
            LinearGradient(gradient: Gradient(stops: [Gradient.Stop(color: Color.white, location: 0), Gradient.Stop(color: Color.green, location: 1)]), startPoint: .topLeading, endPoint: .bottomTrailing)
                .ignoresSafeArea(.all)
